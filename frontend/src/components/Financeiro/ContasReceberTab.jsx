...
const ContasReceberTab = ({ onRefresh }) => {
  ...
  const carregarDados = async () => {
    try {
      ...
      const [contasResponse, categoriasResponse, clientesResponse] =
        await Promise.all([
          financeiroService.listarContasReceber(filtros),
      ...
      setCategorias(
        categoriasResponse.data?.filter((cat) => cat.tipo === 'receita') || []
      )
  ...
  const handleRecebimentoChange = (campo, valor) => {
    setDadosRecebimento((prev) => ({ ...prev, [campo]: valor }))
  }
  ...
  const abrirModalRecebimento = (conta) => {
    ...
    setDadosRecebimento({
      valor_recebido: conta.valor.toString(),
      forma_recebimento: 'dinheiro',
      data_recebimento: new Date().toISOString().split('T')[0],
      juros: '0',
      multa: '0',
  ...
  const processarRecebimento = async () => {
    try {
      if (!dadosRecebimento.valor_recebido) {
        alert('Valor do recebimento é obrigatório')
        return
      }

      await financeiroService.receberConta(contaSelecionada.id, {
        ...dadosRecebimento,
        valor_recebido: parseFloat(dadosRecebimento.valor_recebido),
        juros: parseFloat(dadosRecebimento.juros || 0),
        multa: parseFloat(dadosRecebimento.multa || 0),
        desconto: parseFloat(dadosRecebimento.desconto || 0),
      })
    ...
    <Box sx={{ p: 3 }}>
      ...
      >
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            Controle de clientes, prazos e recebimentos
          </Typography>
        </Box>
            ...
            <Card elevation={2} sx={{ borderRadius: 3 }}>
              <CardContent sx={{ textAlign: 'center', p: 3 }}>
                ...
                <Typography variant="h5" fontWeight="bold" color="success.main">
                  {financeiroService.formatarMoeda(resumo.valor_recebido || 0)}
                </Typography>
                <Typography variant="body2" color="text.secondary">
                  Valor Recebido
                </Typography>
          ...
          <Table>
            <TableHead>
              ...
              >
                ...
                <TableCell sx={{ fontWeight: 600, py: 2 }}>Cliente</TableCell>
      ...
      >
        <DialogTitle sx={{ pb: 1 }}>
          ...
          <Typography variant="body2" color="text.secondary">
            Registre uma nova conta a ser recebida
          </Typography>
        </DialogTitle>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={8}>
              <TextField
                ...
                sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
                placeholder="Ex: Serviço de manutenção, Venda de produto..."
              />
            </Grid>
      ...
      >
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                onChange={(e) =>
                  handleRecebimentoChange('valor_recebido', e.target.value)
                }
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">R$</InputAdornment>
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                value={dadosRecebimento.forma_recebimento}
                onChange={(e) =>
                  handleRecebimentoChange('forma_recebimento', e.target.value)
                }
                sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
              >
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                onChange={(e) =>
                  handleRecebimentoChange('data_recebimento', e.target.value)
                }
                InputLabelProps={{ shrink: true }}
                sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
              />
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                onChange={(e) =>
                  handleRecebimentoChange('desconto', e.target.value)
                }
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">R$</InputAdornment>
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                onChange={(e) =>
                  handleRecebimentoChange('juros', e.target.value)
                }
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">R$</InputAdornment>
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                type="number"
                label="Multa"
                value={dadosRecebimento.multa}
                onChange={(e) =>
                  handleRecebimentoChange('multa', e.target.value)
                }
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">R$</InputAdornment>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                onChange={(e) =>
                  handleRecebimentoChange('observacoes', e.target.value)
                }
                sx={{ '& .MuiOutlinedInput-root': { borderRadius: 2 } }}
        ...
        <DialogActions sx={{ p: 3, pt: 2 }}>
          ...
          <Button
            ...
            disabled={!dadosRecebimento.valor_recebido}
            sx={{ borderRadius: 2, px: 3, fontWeight: 600 }}
          >
